...
export default function SectionTab() {
  return (
    <section className="w-full h-[800px] relative overflow-visible">
      {/* White background */}
      ...
      {/* Blue angled panel */}
      <div
        className="absolute bottom-0 left-0 w-[110%] h-[400px] bg-blue-700"
        style={{ clipPath: "polygon(100% 0, 0 25%, 0 100%, 100% 100%)" }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full px-10 flex items-center">
        ...
        {/* Right Image */}
        <div className="absolute right-10 bottom-20 w-[620px] h-[865px] overflow-true">
          <Image
            src={bgLeft}
